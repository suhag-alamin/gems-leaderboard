...
const BeGemsStar = () => {
    return (
        <div>
           ...
           <Typography sx={{fontSize:{xs:28, md:42}, textAlign: 'center', fontWeight:700, mb:6}} variant='h3'>To be a Gemster</Typography>
            <Typography sx={{width: {xs: '90%', md: '75%'}, margin: 'auto'}} variant='body1'>To participate GEMS NFT Leaderboard, a wide variety of limited edition GEMS’ partner NFTs will be released! <br /> <br />
